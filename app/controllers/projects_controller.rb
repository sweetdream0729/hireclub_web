class ProjectsController < ApplicationController
  ...
  private
    ...
    def project_params
      params.require(:project).permit(:name, :slug, :position, :image_uid, :image, :retained_image, :remove_image, :image_url, :link, :description, :skills_list, :company_id, :completed_on)
    end
end
